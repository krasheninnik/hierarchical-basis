...
//------------------------------------------------------------------------
void FormatConverter::From2x2ToCSR_Real_1_NS(int nb, int* ig, int* sz_iptr, int* sz_jptr)
{
	*sz_iptr = nb + 1;
	*sz_jptr = ig[nb] * 2 + nb;
}
...
void FormatConverter::FromRSFToCSR_Real_2_NS(int nb, int *ig, int *jg, double *di, double *ggl, double * ggu, MKL_INT64 *iptr, MKL_INT64 *jptr, double *aelem)
{
	int i, j, k;
	vector<MKL_INT64> col;
