...
public:
	...
	void From2x2ToCSR_Real_1_NS(int nb, int* ig, int* sz_iptr, int* sz_jptr);
	...
	void FromRSFToCSR_Real_2_NS(int nb, int * ig, int * jg, double * di, double * ggl, double * ggu, MKL_INT64 * iptr, MKL_INT64 * jptr, double * aelem);
